from .base import ToolSpec, common_timeout, name_schema, oc_named, oc_simple
...
'operator_related_resources': ToolSpec('operator_related_resources','Recursos relacionados do operador.',lambda p: run_oc(['describe','clusteroperator',validate_k8s_name(p['name'],'operator')], timeout=common_timeout(p)).to_dict(),name_schema('operator')),
