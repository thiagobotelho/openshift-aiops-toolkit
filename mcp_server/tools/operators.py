from .base import ToolSpec, common_oc_kwargs, name_schema, oc_named, oc_simple
...
'operator_related_resources': ToolSpec('operator_related_resources','Recursos relacionados do operador.',lambda p: run_oc(['describe','clusteroperator',validate_k8s_name(p['name'],'operator')], **common_oc_kwargs(p)).to_dict(),name_schema('operator')),
